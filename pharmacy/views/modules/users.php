          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input class="form-control input-lg" type="text" name="newSalary" placeholder="Add Salary" required>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input class="form-control input-lg" type="text" name="EditSalary" placeholder="Add new Salary" required>
                <br>
