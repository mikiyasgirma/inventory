	...
	$.ajax({
		...
		url:"ajax/products.ajax.php",
      	...
      	success:function(answer){
	          ...
	          '<div class="col-xs-5 enterQuantity">'+
	          ...
	          '<br><br><br><div class="col-xs-9 enterPrice" style="padding-left:50px">'+
...
$("#newPaymentMethod").change(function(){
	...
	if(method == "cash"){
		...
		$(this).parent().parent().parent().children(".paymentMethodBoxes").html(
			 ...
			 '<br><br><br><div class="col-xs-7" id="getCashChange" style="padding-left:50px">'+
