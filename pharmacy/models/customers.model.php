...
class ModelCustomers{
	...
	static public function mdlAddCustomer($table, $data){
		...
		$stmt = Connection::connect()->prepare("INSERT INTO $table(name, phone) VALUES (:name, :phone)");
	...
	static public function mdlEditCustomer($table, $data){
		...
		$stmt = Connection::connect()->prepare("UPDATE $table SET name = :name, phone = :phone, WHERE id = :id");
