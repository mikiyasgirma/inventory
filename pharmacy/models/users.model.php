...
class UsersModel{
	...
	static public function mdlAddUser($table, $data){
		...
		$stmt = Connection::connect()->prepare("INSERT INTO $table(name, user, password, profile, photo, salary) VALUES (:name, :user, :password, :profile, :photo, :salary)");
	...
	static public function mdlEditUser($table, $data){
		...
		$stmt = Connection::connect()->prepare("UPDATE $table set name = :name, password = :password, profile = :profile, photo = :photo, salary = :salary WHERE user = :user");
