...
class ProductsModel{
	...
	static public function mdlAddProduct($table, $data){
		...
		$stmt = Connection::connect()->prepare("INSERT INTO $table(idCategory, code, description, generic_name, expire_date, display_box, stock, buyingPrice, sellingPrice, unit) VALUES (:idCategory, :code, :description, :generic_name, :expire_date, :display_box, :stock, :buyingPrice, :sellingPrice, :unit)");
		...
		$stmt->bindParam(":display_box", $data["display_box"], PDO::PARAM_STR);
	...
	static public function mdlEditProduct($table, $data){
		...
		$stmt = Connection::connect()->prepare("UPDATE $table SET idCategory = :idCategory, description = :description, generic_name = :generic_name, expire_date = :expire_date, display_box = :display_box, stock = :stock, buyingPrice = :buyingPrice, sellingPrice = :sellingPrice, unit =:unit WHERE code = :code");
